...
class BookDTO:
    """
        Additional class. Data Transfer Object for transferring book data.
    ...
    """
    def __init__(
        self, title: str, description: str, link: str, source_page: str
    ):
        self.title = title
    ...
    @staticmethod
    def get_image(page_url: str) -> str:
        """
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                image = bs.find(
                    class_='postImg postImgAligned img-right'
                ).attrs['title']
                return image
            else:
